...
const car = [
    { title: 'Basic Wash', copy: 'Exterior rinse and soap application with a quick drying.', button: 'GHC 40.00' },
    { title: 'Luxury Wash', copy: 'Comprehensive exterior wash with hand washing and waxing, plus detailed interior vacuuming and wipe-down.', button: 'GHC 60.00' },
    { title: 'Detailed Wash', copy: ' Deep cleaning both inside and out, extensive interior detailing, including shampooing of carpets and upholstery.', button: 'GHC 120.00' },
...
const Premium = () => {
    ...
    return (
        <div className="flex items-center flex-col gap-10 justify-center p-10">
            ...
            <h1 className='text-5xl font-extrabold  animate-fadeInColorChange'>AQUAGLEAM AUTO WASH</h1>
