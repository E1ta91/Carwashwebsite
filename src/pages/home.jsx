...
const Home = () => {
  return (
    <div className="bg-[#0F6EDB] w-screen h-screen overflow-x-hidden">
      ...
      <div id="home" className="container mt-14 flex flex-col lg:flex-row lg:justify-between lg:items-center w-full px-4 lg:px-0 overflow-hidden">
        <div className="lg:max-w-[62%] mb-11 mx-auto lg:mx-0 z-10">
          <img src={hd} alt="hero" className=" max-w-[100%]; h-auto" />
        </div>
