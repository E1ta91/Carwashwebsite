...
const Home = () => {
  return (
    <div className="bg-[#0F6EDB] w-screen h-screen m-0 p-0 overflow-hidden">
      ...
      <div id="home" className="container mx-auto mt-14 flex flex-col lg:flex-row lg:justify-between lg:items-center w-full px-4 lg:px-0">
        <div className="lg:max-w-[62%] mb-11 mx-auto lg:mx-0 z-10">
          <img src={hd} alt="hero" className="w-full h-auto" />
        </div>

        <div className="text-center lg:text-left lg:max-w-[40%] z-10 px-4 lg:px-0">
          <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl leading-[1.2] text-white">
            Experience the Ultimate Shine!
          </h1>
          <p className="mt-4 text-base sm:text-lg md:text-xl leading-[28px] font-normal italic wrapper p-2 rounded-2xl text-white">
